...
def plot(scores, mean_scores, PLOT_FNAME, save_plot=False):
    ...
    if save_plot:
        ...
        IMG_Path = os.path.join(PLOT_DIR, PLOT_FNAME)
...
VISION4 = (Direction.UP, Direction.RIGHT, Direction.DOWN, Direction.LEFT)
